...
| [demo-site-layout.json](demo-site-layout.json) | `site` | [altrasia-world-map-overlay-example.png](../../../docs/guides/reference-images/altrasia-world-map-overlay-example.png) |
| [demo-stack-layout.json](demo-stack-layout.json) | `stack` | [altrasia-level-stack-example.png](../../../docs/guides/reference-images/altrasia-level-stack-example.png) |
