...
| ID | Requirement |
|----|-------------|
| CC-1 | `exits[]` on each scene: exitId, label, targetSceneId, kind (`door` \| `path` \| `portal`; Phase 6 adds `stairs` \| `ladder` \| `elevator` \| `shaft` for vertical). Optional: `travelSteps`, `direction`, `vertical`, `levelDelta` ([14-web-ui.md](14-web-ui.md), [18-location-maps.md](18-location-maps.md) MAP-10). |
