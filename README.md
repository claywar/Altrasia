...
| | |
|--|--|
| **Design specifications** | Complete (normative docs `00`–`26`) |
| **Implementation** | **v1 + v1.1 + Phase 3–6 wedge** — reflection (AO-8), idle social/banter, commissions, MapDraft; see [docs/IMPLEMENTATION-CHECKLIST.md](docs/IMPLEMENTATION-CHECKLIST.md) |
| **Shipped** | **Alpha** — spatial play, commissions, debate, MapDraft, approvals, evidence, 224+ pytest + Playwright e2e |
